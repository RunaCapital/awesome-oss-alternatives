...
Awesome list of open-source startups which substitute big closed-sourced brothers. We call it the "OSS Clone Wars". Maintained by folks at [Runa Capital](https://runacap.com/). 
...
- [Nhost](https://nhost.io/) - Firebase Alternative with GraphQL ([repo](https://github.com/nhost/nhost)) [![](https://img.shields.io/github/stars/nhost/nhost?style=social)](https://github.com/nhost/nhost)
